  ...
  for(v in 1:3){	
    ...
    for(i in 1:B){
      ...
      if(k==1){
        ...
        L1_16<-rgamma(n.gran*n.each,l.param.inv,1/l.param.inv)
      ...
      if(k==2){
        ...
        l.param2<-(sum(range(l.param))+0-l.param.inv)-(mean(l.param)-mean(l.param.inv))
        L1_25<-rgamma(n.gran*n.each,l.param.inv,1/l.param.inv)
      ...
      if(k==3){
        ...
        L1_36<-rgamma(n.gran*n.each,l.param.inv,1/l.param.inv)
