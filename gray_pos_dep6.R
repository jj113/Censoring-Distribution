  ...
  for(v in 1:3){	
    ...
    for(i in 1:B){
      ...
      if(k==1){
        ...
        L2_16<-rgamma(n.gran*n.each,l.param.inv,1/l.param.inv)
      ...
      if(k==2){
        ...
        L2_25<-rgamma(n.gran*n.each,l.param.inv,1/l.param.inv)
        L<-rgamma(n.gran*n.each,l.param2,1/l.param2)
        L_t = rgamma(10000,l.param2,1/l.param2)
      ...
      if(k==3){
        ...
        L2_36<-rgamma(n.gran*n.each,l.param.inv,1/l.param.inv)
